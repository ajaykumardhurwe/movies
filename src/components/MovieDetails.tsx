...
const MovieDetails: React.FC = () => {
  ...
  useEffect(() => {
    ...
    script.src = '//pl26918625.profitableratecpm.com/f0/76/a6/f076a6eefddfd4778099dc31d727a523.js';
    script.async = true;
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            <div>
              ...
              {/* 🔻 Optional: Add ad placeholder if needed */}
              <div id="ad-slot" className="mt-10">
                {/* Ad will be injected globally via script */}
              </div>
